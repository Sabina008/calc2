...
class Calculator:
    ...
    def get_result_of_last_calculation_added_to_history():
        ...
        high level support for doing this and that.
        """
        # -1 gets the last item added to the list automaticly and you can expect
        # it to have the get result method
    ...
    def multiply_numbers(value_a, value_b):
        ...
        #this is a shorthand way to create the multiplication object and added
        # it the history in one line
